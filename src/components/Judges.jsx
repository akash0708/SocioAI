			...
			<div className="flex flex-col items-center">
				...
				<div className="flex justify-between w-full">
					<div>
						...
						<h2 className="text-lg font-medium text-[#0f5132]">{judge.designation}</h2>
					</div>
					<div className="flex gap-x-2 items-center text-3xl pb-3 pr-2">
            <a href={judge.instagram} target="_blank" className="hover:text-[#0a5c36]">
						<FaInstagram />
            </a>
            <a href={judge.linkedin} target="_blank" className="hover:text-[#0a5c36]">
						<FaLinkedin />
            </a>
					</div>
				</div>
